...
// Category doit être appelé avant class program donc implements DependentFixtureInterface et getdependencies pour ordre
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach (self::PROGRAMS as $title => $data) {
            ...
            $program->setCategory($this->getReference('categorie_'.$data['category']));
    ...
    //nécessité d'appeler CategoryFixtures avant ProgramFixtures
